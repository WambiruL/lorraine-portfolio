...
import SharedReveal from "@/components/shared/Reveal";

function Reveal(props: React.ComponentProps<typeof SharedReveal>) {
  return <SharedReveal y={36} duration={0.9} {...props} />;
}
